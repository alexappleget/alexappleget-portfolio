...
export const Contact = () => {
  return (
    <section id="contact" className="py-20 px-4 bg-background-secondary relative overflow-hidden">
        ...
        <div className="flex flex-wrap items-center justify-center gap-4">
          {socialLinks.map((link) => (
            <a
              ...
              className="px-6 py-3 border-2 border-primary/50 rounded-lg text-text-muted hover:text-primary hover:border-primary hover:bg-primary/10"
            >
              {link.name}
            </a>
          ))}
